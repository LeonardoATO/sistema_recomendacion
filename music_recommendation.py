# -*- coding: utf-8 -*-
"""music_recommendation (3).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/12JI0GhcXE_XX5phiPTvpbnfClmqP9MpW
...
best_report = classification_report(y_test, best_y_pred_RandomForest_proba)
...
best_model_LogisticRegression = LogisticRegression(C=1.0, class_weight='balanced')
...
print(f"Canciones recomendadas para '{input_song_name}':")
